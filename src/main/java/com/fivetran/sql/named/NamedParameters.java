package com.fivetran.sql.named;/*
...
/**
 * Based on org.springframework.jdbc.core.namedparam.NamedParameterUtils
 */
public class NamedParameters {
    ...
    public static Object[] buildValueArray(
            ParsedSql parsedSql, Map<String, ?> paramSource, List<SqlParameter> declaredParams) {
...
//    /**
//     * Convert parameter types from an Map<String, ?> into a corresponding int array.
...
//     * @param paramSource the source for named parameters
//     */
//    public static int[] buildSqlTypeArray(ParsedSql parsedSql, Map<String, ?> paramSource) {
...
//
//    /**
//     * Convert parameter declarations from an Map<String, ?> to a corresponding List of SqlParameters.
//     * This is necessary in order to reuse existing methods on JdbcTemplate.
...
//     * @param paramSource the source for named parameters
//     */
//    public static List<SqlParameter> buildSqlParameterList(ParsedSql parsedSql, Map<String, ?> paramSource) {
//        List<String> paramNames = parsedSql.getParameterNames();
...
//     * {@link #substituteNamedParameters(ParsedSql, Map<String, ?>)}.
//     * @param sql the SQL statement
...
//     * @return the SQL statement with substituted parameters
//     */
//    public static String substituteNamedParameters(String sql, Map<String, ?> paramSource) {
//        ParsedSql parsedSql = parseSqlStatement(sql);
...
//     * Convert a Map of named parameter values to a corresponding array.
//     * <p>This is a shortcut version of
//     * {@link #buildValueArray(ParsedSql, Map<String, ?>, java.util.List)}.
//     * @param sql the SQL statement
...
//        ParsedSql parsedSql = parseSqlStatement(sql);
//        return buildValueArray(parsedSql, new MapMap<String, ?>(paramMap), null);
//    }
